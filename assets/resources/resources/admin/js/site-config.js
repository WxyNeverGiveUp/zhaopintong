(function(){
    ...
    var site ={
        website:'http://www.dsjyw.net/',//站点地址
        staticWebsite: 'http://www.dsjyw.net/assets/resources/', // 前端服务器地址
        puiWebsite: 'http://www.dsjyw.net/assets/resources/puiresources/' //pui地址
    }
    ...
    _pw_env = {
        ...
        pkgs:[
            {
                name: 'io',
                path: site.staticWebsite + 'resources/admin/js/'
            },
            {
                name: 'module',
                path: site.staticWebsite + 'resources/admin/js/'
            ...
            {
                name: 'common',
                path: site.staticWebsite+'resources/admin/js/page'
            }
        ],
        ...
        modSettings:{
            ...
            dialog:{
                ...
                position: 'fixed',
                themeUrl: site.staticWebsite + 'resources/admin/css/widget/core.css'
            },
            ztree:{
                themeUrl: site.staticWebsite + 'resources/admin/css/widget/core.css'
            },
            ...
            tooltip:{
                ...
                styles:{
                    uri: site.staticWebsite + 'resources/admin/css/widget/core.css'
                }
            }
        },
        //统一错误信息
        ...
        url:{
            module:{
                ...
                linkage:{
                    getCity:site.website+'user/cache/linkCity/provinceId',
            ...
            recruit:{
                ...
                recruit:{
                    ...
                    getCity:site.website+'admin/teacherRecruitment/teacherRecruitment/getCityJson'
                },
                interview:{
            ...
            employment: {
                student: {
                    ...
                    del: site.website+'test/api-data/012.json',
                    /*生源结构*/
                    // searchStruct: site.website+'test/api-data/32.json',
                    searchStruct: site.website+'data/queryStudentStructure',
                    // searchOrderbyStruct: site.website+'test/api-data/32.json',
                    searchOrderbyStruct: site.website+'data/queryStudentStructure',
                    /*就业率*/
                    // searchRate: site.website+'test/api-data/32.json',
                    // searchOrderbyRate: site.website+'test/api-data/32.json',
                    searchRate: site.website+'data/queryEmploymentRate',
                    searchOrderbyRate: site.website+'data/queryEmploymentRate',
                    /*拟就业率*/
                    searchRateNi: site.website+'test/api-data/32.json',
                    searchOrderbyRateNi: site.website+'test/api-data/32.json',
                    /*就业结构*/
                    searchStructEmp: site.website+'test/api-data/32.json',
                    searchOrderbyStructEmp: site.website+'test/api-data/32.json'
                }
            }
        }
    }
