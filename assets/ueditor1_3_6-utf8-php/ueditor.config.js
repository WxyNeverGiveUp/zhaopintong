...
(function () {
	...
	//var location = path+'?r=';
	//var imgpath = path.substring(0,path.length-9);
	
//	alert(location);
//	alert(path.substring(0,path.length-9));
	
	
	
    //var fileURL = window.UEDITOR_HOME_URL||imgpath;
    
    //var logicURL = window.UEDITOR_HOME_URL||location;
    ...
    window.UEDITOR_CONFIG = {
        ...
        //,savePath: ['../uploadFile', 'upload1', 'upload2', 'upload3' ]    //图片保存在服务器端的目录， 默认为空， 此时在上传图片时会向服务器请求保存图片的目录列表，
        ...
        //word转存配置区
        //,wordImageUrl:logicURL+"admin/ueditor/uploadimg"
        //,wordImagePath:fileURL
