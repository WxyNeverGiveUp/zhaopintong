 ...
 */
class Companyweek2017 extends CActiveRecord
{
    /**
    ...
    return array(
        ...
        'city'=>array(self::MANY_MANY, 'City',
            't_company_cityweek2017(company_id, city_id)'),
        ...
        'concern'=>$arr,
        'concern2'=>$arr2,
        'companycityweek2017'=>array(SELF::BELONGS_TO,'CompanyCityweek2017','','on'=>'t.id=companycityweek2017.company_id'),
