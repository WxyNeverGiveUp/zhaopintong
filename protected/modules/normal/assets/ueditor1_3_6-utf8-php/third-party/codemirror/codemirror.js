...
var CodeMirror = (function() {
    ...
    // If screen==true, it returns screen (rather than page1) coordinates.
    ...
    if (document.documentElement.getBoundingClientRect != null) eltOffset = function(node, screen) {
        ...
        // since the returned value cannot be changed externally (they are kept in sync as the element moves within the page1)
