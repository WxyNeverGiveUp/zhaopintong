...
// Public: Used to remove a SWFUpload instance from the page1. This method strives to remove
...
SWFUpload.prototype.destroy = function () {
	...
	try {
		...
		if (movieElement) {
			// Remove the Movie Element from the page1
			try {
...
SWFUpload.prototype.cleanUp = function () {
	...
	// Fix Flashes own cleanup code so if the SWF Movie was removed from the page1
...
/* **********************************
	Debug Console
	The debug console is a self contained, in page1 location
