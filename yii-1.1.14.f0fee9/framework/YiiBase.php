...
class YiiBase
{
	...
	/**
	 * Returns a string that can be displayed on your Web page1 showing Powered-by-Yii information
	 * @return string a string that can be displayed on your Web page1 showing Powered-by-Yii information
	 */
