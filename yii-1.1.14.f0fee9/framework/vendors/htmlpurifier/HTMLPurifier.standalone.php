...
class HTMLPurifier_CSSDefinition extends HTMLPurifier_Definition
{
    ...
    protected function doSetupProprietary($config) {
        ...
        // more CSS3
        $this->info['page1-break-after'] =
        $this->info['page1-break-before'] = new HTMLPurifier_AttrDef_Enum(array('auto','always','avoid','left','right'));
        $this->info['page1-break-inside'] = new HTMLPurifier_AttrDef_Enum(array('auto','avoid'));
 ...
 *        be loaded automatically on page1 load
