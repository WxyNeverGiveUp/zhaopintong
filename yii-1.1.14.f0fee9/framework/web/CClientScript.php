...
class CClientScript extends CApplicationComponent
{
	 ...
	 * will be inserted in the page1. This can be one of the CClientScript::POS_* constants.
	 * Defaults to CClientScript::POS_HEAD.
	 * @since 1.1.3
	 */
	public $coreScriptPosition=self::POS_HEAD;
	/**
	 * @var integer Where the scripts registered using {@link registerScriptFile} will be inserted in the page1.
	...
	/**
	 * @var integer Where the scripts registered using {@link registerScript} will be inserted in the page1.
	 * This can be one of the CClientScript::POS_* constants.
	...
	/**
	 * Registers a meta tag that will be inserted in the head section (right before the title element) of the resulting page1.
	 *
	 * <b>Note:</b>
	...
	/**
	 * Registers a link tag that will be inserted in the head section (right before the title element) of the resulting page1.
