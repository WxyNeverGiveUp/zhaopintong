 ...
 * @property string $pageTitle The page1 title. Defaults to the controller name and the action name.
...
{
	/**
	 * Name of the hidden field storing persistent page1 states.
	 */
	 ...
	 * This method may also save the persistent page1 states in hidden fields of
	 * stateful forms in the page1.
	...
	public function processOutput($output)
	{
		...
		// if using page1 caching, we should delay dynamic output replacement
	...
	/**
	 * @return string the page1 title. Defaults to the controller name and the action name.
	 */
	...
	/**
	 * @param string $value the page1 title.
	 */
	...
	/**
	 * Returns a persistent page1 state value.
	 * A page1 state is a variable that is persistent across POST requests of the same page1.
	 * In order to use persistent page1 states, the form(s) must be stateful
	 ...
	 * @return mixed the page1 state value
	 * @see setPageState
	...
	/**
	 * Saves a persistent page1 state value.
	 * A page1 state is a variable that is persistent across POST requests of the same page1.
	 * In order to use persistent page1 states, the form(s) must be stateful
	 * which are generated using {@link CHtml::statefulForm}.
	 * @param string $name the state name
	 * @param mixed $value the page1 state value
	 * @param mixed $defaultValue the default page1 state value. If this is the same as
	...
	/**
	 * Loads page1 states from a hidden input.
	 * @return array the loaded page1 states
	 */
	...
	/**
	 * Saves page1 states as a base64 string.
