 ...
 *
 * CDataProviderIterator iterates over the results of a data provider, starting at the first page1
 * of results and ending at the last page1. It is usually only suited for use with {@link CActiveDataProvider}.
 *
...
class CDataProviderIterator extends CComponent implements Iterator, Countable
{
	...
	/**
	 * Loads a page1 of items
	 * @return array the items from the next page1 of results
	 */
