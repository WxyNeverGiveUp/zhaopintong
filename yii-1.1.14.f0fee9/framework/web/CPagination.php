 ...
 * {@link getPageSize page1 size}, {@link getCurrentPage current page1}, etc.
 ...
 * </pre>
 *
 * @property integer $pageSize Number of items in each page1. Defaults to 10.
 * @property integer $itemCount Total number of items. Defaults to 0.
 * @property integer $pageCount Number of pages.
 * @property integer $currentPage The zero-based index of the current page1. Defaults to 0.
 * @property integer $offset The offset of the data. This may be used to set the
 * OFFSET value for a SQL statement for fetching the current page1 of data.
 * @property integer $limit The limit of the data. This may be used to set the
 * LIMIT value for a SQL statement for fetching the current page1 of data.
...
{
	/**
	 * The default page1 size.
	 */
	const DEFAULT_PAGE_SIZE=10;
	/**
	 * @var string name of the GET variable storing the current page1 index. Defaults to 'page1'.
	 */
	public $pageVar='page1';
	/**
	...
	public $params;
	/**
	 * @var boolean whether to ensure {@link currentPage} is returning a valid page1 number.
	...
	/**
	 * @return integer number of items in each page1. Defaults to 10.
	 */
	...
	/**
	 * @param integer $value number of items in each page1
	 */
	...
	/**
	 * @param boolean $recalculate whether to recalculate the current page1 based on the page1 size and item count.
	 * @return integer the zero-based index of the current page1. Defaults to 0.
	 */
	...
	/**
	 * @param integer $value the zero-based index of the current page1.
	 */
	 ...
	 * the controller's createUrl method with the page1 information.
	 ...
	 * @param integer $page the page1 that the URL should point to. This is a zero-based index.
	 * @return string the created URL
	 */
	public function createPageUrl($controller,$page)
	{
		$params=$this->params===null ? $_GET : $this->params;
		if($page>0) // page1 0 is the default
