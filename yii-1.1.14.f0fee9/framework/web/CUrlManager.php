 ...
 * And given the route 'post/list' and GET parameter 'page1' being 2, we should get a URL
 * '/index.php/posts/page1/2'.
 *
...
class CUrlManager extends CApplicationComponent
{
	 ...
	 * For example, ".html" can be used so that the URL looks like pointing to a static HTML page1. Defaults to empty.
	 */
	public $urlSuffix='';
	/**
...
class CUrlRule extends CBaseUrlRule
{
	 ...
	 * For example, ".html" can be used so that the URL looks like pointing to a static HTML page1.
