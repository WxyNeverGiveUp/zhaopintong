...
class CHtml
{
	 ...
	 * on the page1. Elements injected into the page1 at a later time will not be processed.
	 *
	...
	/**
	 * Generates a meta tag that can be inserted in the head section of HTML page1.
	...
	/**
	 * Generates a link tag that can be inserted in the head section of HTML page1.
	 ...
	 * meta tag with {@link CClientScript} so that the page1 can be refreshed in
	 * the specified seconds.
	 * @param integer $seconds the number of seconds to wait before refreshing the page1
	 * @param string $url the URL to which the page1 should be redirected to. If empty, it means the current page1.
	 * @since 1.1.1
	 */
	 ...
	 * hidden field for storing persistent page1 states. You should use this method to generate
	 * a form tag if you want to access persistent page1 states when the form is submitted.
	 * @param mixed $action the form action URL (see {@link normalizeUrl} for details about this parameter.)
	 * @param string $method form method (e.g. post, get)
	 * @param array $htmlOptions additional HTML attributes (see {@link tag}).
	 * @return string the generated form tag.
	...
	/**
	 * Generates a hidden field for storing persistent page1 states.
	 * This method is internally used by {@link statefulForm}.
	 * @param string $value the persistent page1 states in serialized format
...
EOD;
	 ...
	 * For example, <code>array('post/list', 'page1'=>3)</code> may be used to generate the URL
	 * <code>/index.php?r=post/list&page1=3</code>.
	 *
