 ...
 * the whole page1 containing the form is submitted. If there is any validation error,
 * CActiveForm will render the error in the page1 back to user.</li>
...
class CActiveForm extends CWidget
{
	 ...
	 * If not set, the current page1 URL is used.
	 */
	public $action='';
	/**
	...
	/**
	 * @var mixed form element to get initial input focus on page1 load.
	 *
	 ...
	 *
	 * Example - set input focus on page1 load to:
	 * <ul>
