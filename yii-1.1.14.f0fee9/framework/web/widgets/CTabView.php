 ...
 * when the page1 is initially loaded, set {@link activeTab} to be the ID of the desired tab.
 *
 * @author Qiang Xue <qiang.xue@gmail.com>
...
class CTabView extends CWidget
{
	...
	public $cssFile;
	/**
	 * @var string the ID of the tab that should be activated when the page1 is initially loaded.
