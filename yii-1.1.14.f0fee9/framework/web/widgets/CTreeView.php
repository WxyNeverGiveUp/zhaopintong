...
class CTreeView extends CWidget
{
	 ...
	 * When the page1 is displayed, the browser will request this URL with a GET parameter
	...
	public $toggle;
	/**
	 * @var string Persist the tree state in cookies or the page1 location. If set to "location", looks for
	 ...
	 * each click to a cookie and restores that state on page1 load.
	 */
	public $persist;
	/**
