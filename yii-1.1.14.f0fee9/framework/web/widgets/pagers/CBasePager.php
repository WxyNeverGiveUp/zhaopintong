 ...
 *
 * It provides the calculation of page1 count and maintains the current page1.
 *
 * @property CPagination $pages The pagination information.
 * @property integer $pageSize Number of items in each page1.
...
abstract class CBasePager extends CWidget
{
	...
	/**
	 * @return integer number of items in each page1.
	 ...
	 * @param integer $page the page1 that the URL should point to.
