...
/**
 * CBreadcrumbs displays a list of links indicating the position of the current page1 in the whole website.
 *
 * For example, breadcrumbs like "Home > Sample Post > Edit" means the user is viewing an edit page1
 * for the "Sample Post". He can click on "Sample Post" to view that page1, or he can click on "Home"
 ...
 * </pre>
 *
 * Because breadcrumbs usually appears in nearly every page1 of a website, the widget is better to be placed
...
class CBreadcrumbs extends CWidget
{
	 ...
	 * If an element's key is an integer, it means the element will be rendered as a label only (meaning the current page1).
	 *
	 * The following example will generate breadcrumbs as "Home > Sample post > Edit", where "Home" points to the homepage,
	 * "Sample post" points to the "index.php?r=post/view&id=12" page1, and "Edit" is a label. Note that the "Home" link
