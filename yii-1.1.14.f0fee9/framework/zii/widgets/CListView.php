 ...
 * and pagination can be done in AJAX mode or normal page1 request. A benefit of using CListView is that
...
class CListView extends CBaseListView
{
	 ...
	 * to persist state of list across page1 revisits.  Note, there are two limitations for this feature:
	 * - this feature is only compatible with browsers that support HTML5.
	 * - expect unexpected functionality (e.g. multiple ajax calls) if there is more than one grid/list on a single page1 with enableHistory turned on.
	 * @since 1.1.11
	*/
